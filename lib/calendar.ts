export function getGoogleCalendarUrl() {
  ...
  const details = encodeURIComponent(
    "Soirée Collaboration Exclusive: DUSK EVE SOUNDS × BASALTE\nBarbossa — 3956 A Boul. Saint-Laurent, Montréal, QC H2W 1Y3\nPrésente ton QR Code à l'entrée. Arrive tôt, repars tard!"
  );
  const location = encodeURIComponent("Barbossa, 3956 A Boul. Saint-Laurent, Montréal, QC H2W 1Y3");
...
LOCATION:Barbossa\\, 3956 A Boul. Saint-Laurent\\, Montréal\\, QC H2W 1Y3
